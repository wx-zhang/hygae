...
class SokobanEnvConfig(BaseEnvConfig):
    ...
    # "cot", "free_think", "no_think", "grounding", "worldmodeling", "grounding_worldmodeling"
    ...
    visual_prompt: bool = False  # when True, prepend an example game image to the first observation
