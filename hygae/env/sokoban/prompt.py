...
Symbols:
If there is a image provided, the red square with center point is the target, the yellow squre with red cross is the box, the green monster is the player.
If there is no image provided, the symbols are:
...
def action_template(**kwargs):
    ...
    observation = kwargs.get(
        "img_str", "The player pushed the box closer to the target"
    )
...
FORMAT_CONFIGS = {
    "cot": {
        ...
        "description": "Think step by step and provide your answer",
        "example": "<think>The box is one step above me, and the target is two steps above me, I need to go up then push the box up to the target.</think><answer>Up{action_sep}Up</answer>",
    },
    "free_think": {
        "format": "<think>...</think><answer>...</answer>",
    ...
    "grounding_worldmodeling+": {
        "format": "<think><observation>...</observation><reasoning>...</reasoning><prediction>...</prediction></think><answer>...</answer>",
        "description": "You should first give the description of your observation, then your reasoning, then predict the next state, and finally your answer.",
        "additional_info": "For the content you provide within the `<observation>` and `<prediction>` tags, you must strictly describe the relative position of the `target`(red square with center point) and any visible `box`(yellow squre with red cross) objects **relative to the player**.  Only black positions are movable positions.  Use ONLY the terms `above`, `below`, `left`, `right`, or `same` for describing these relationships. Do not repeat previous generations. ONLY look at the most recent image.",
        "example": "<think><observation>The box is below and to right of the player and the target is below and to the right of the player</observation><reasoning>I need to go right then go down to push the box down to the target</reasoning><prediction>The player will be above the box and target, the target and box will be at the same row.</prediction></think><answer>Right{action_sep}Down</answer>",
    },
    "grounding_symbolic": {
        "format": "<think><observation>...</observation><reasoning>...</reasoning></think><answer>...</answer>",
...
format_prompt = {
    format_type: format_prompt_generator(format_type) for format_type in FORMAT_CONFIGS
}
